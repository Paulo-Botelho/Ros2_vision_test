...
class running_inference():
    def get_cnn_files():
        '''Gets the CNN filenames, despite the PC file structure.'''

        #forçando o path dos arquivos
        #robocup_folder = os.path.join(os.path.expanduser('~'), "cros2_ws/src/object_finder\object_finder")
        robocup_folder = "C:\cros2_ws\src\object_finder\object_finder"
